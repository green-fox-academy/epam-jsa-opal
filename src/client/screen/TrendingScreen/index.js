...
import VideoFullViewComponent from '../../components/VideoFullViewComponent';
import './index.scss';
    ...
    return (
      <div className="homecontainer">
        ...
        <div className="main">
          ...
          <div className="VideoFullViewComponent"> <VideoFullViewComponent videoLists={this.state.videoLists}/> </div>
        </div>
      </div>
    );
  }
